...
class UserDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_detail" do
    assert_difference('UserDetail.count') do
      post user_details_url, params: { user_detail: { Address: @user_detail.Address, Name: @user_detail.Name, User_id: @user_detail.User_id, photo: @user_detail.photo } }
    end
  ...
  test "should update user_detail" do
    patch user_detail_url(@user_detail), params: { user_detail: { Address: @user_detail.Address, Name: @user_detail.Name, User_id: @user_detail.User_id, photo: @user_detail.photo } }
